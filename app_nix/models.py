...
class Anunciante(models.Model):
    tipo_anunciante = models.CharField(max_length=20, default='Tipo Anunciante')
...
class AnuncioVeiculo(models.Model):
    ...
    def __str__(self):
        combined_string = f"{self.pk}/{self.anunciado_por}/{self.nome_marca}/{self.nome_modelo}/{self.ano}"
